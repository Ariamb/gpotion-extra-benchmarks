...
__global__
void dotproduct(float *a, float *b, float *c, int tpb, int n)
{
	int tpb = (tpb + 0);
...
extern "C" void dotproduct_call(ErlNifEnv *env, const ERL_NIF_TERM argv[], ErlNifResourceType* type)
  {
  ...
  list = tail;
   ...
   dotproduct<<<blocks, threads>>>(arg1,arg2,arg3,arg4,arg5);
